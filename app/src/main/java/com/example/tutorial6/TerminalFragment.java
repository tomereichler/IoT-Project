...
public class TerminalFragment extends Fragment implements ServiceConnection, SerialListener {
    ...
    public static String[] getDataRow(){ return dataRow; }
            ...
            if(newline.equals(TextUtil.newline_crlf) && msg.length() > 0) {
                ...
                if (msg_to_save.length() > 1){
                    ...
                    try {
                        ...
                        String[] row = new String[]{parts[1],parts[0], parts[2], parts[3]};
                        dataRow = row;
                        Log.d("Terminal", "row = [" + dataRow[0] + ", " + dataRow[1] + ", " + dataRow[2] + ", " + dataRow[3] + "]");
